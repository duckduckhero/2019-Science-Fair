import g2p
#자음과 모음에서 가장 큰 Substring 길이 찾은 다음에 둘이 더한다
import openpyxl
...
for r in ws.rows:
    if r[0].value!='단어1':
        ...
        print(w1v)
        print(w2v)
        vlcs = lcsubstring_length(w1v, w2v) #모음 최장 연속 구간
        clcs = lcsubstring_length(w1c, w2c) #자음 최장 연속 구간
